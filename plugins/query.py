...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("🔍 SΞΛᏒCH 🔍", url="https://t.me/ms_moviegroup"), 
            InlineKeyboardButton("⚡ UᎮDΛTΞS ⚡", url="https://t.me/only_botz")
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('❣️ SUᎮᎮԾᏒϮ ❣️', callback_data='source')
            ],[
            InlineKeyboardButton('🏠 𝙷𝙾𝙼𝙴 🏠', callback_data='start'),
            InlineKeyboardButton('🔐 𝙲𝙻𝙾𝚂𝙴 🔐', callback_data='close_data')
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('♻️sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴛ ᴄʜᴀɴɴᴇʟ♻️', url='https://youtube.com/@technical_rakesh_01')
            ],[
            InlineKeyboardButton('♻️𝚁𝙴𝙿𝙾𝚁𝚃 𝙱𝚄𝙶𝚂 & 𝙵𝙴𝙴𝙳𝙱𝙰𝙲𝙺♻️', url='https://t.me/Cynite_movies_group12')
            ],[
